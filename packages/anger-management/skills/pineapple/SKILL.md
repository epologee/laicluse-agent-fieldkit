...
user-invocable: true
description: >-
  Invoked as /pineapple. A fix-now safeword: the operator still has enough mental
...
The operator just used "pineapple" as a fix-now safeword. This is not praise, not a
