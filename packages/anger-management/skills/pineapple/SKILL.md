...
user-invocable: true
description: >-
  Explicit fix-now safeword /pineapple; route one caught problem into immediate durable repair.
disable-model-invocation: true
---

# /pineapple

The operator just used "pineapple" as a fix-now safeword: stop the current work and
