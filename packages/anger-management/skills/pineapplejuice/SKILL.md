...
user-invocable: true
description: >-
  Explicit fix-now safeword /pineapplejuice; route one caught problem into immediate durable repair.
disable-model-invocation: true
---

# /pineapplejuice

The operator just used "pineapplejuice" as a fix-now safeword: stop the current work and
