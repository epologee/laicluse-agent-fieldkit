...
user-invocable: true
description: >-
  Explicit fix-now safeword /safeword; route one caught problem into immediate durable repair.
disable-model-invocation: true
---

# /safeword

The operator just used "safeword" as a fix-now safeword: stop the current work and
