...
user-invocable: true
description: >-
  Invoked as /safeword. A fix-now safeword: the operator still has enough mental
...
The operator just used "safeword" as a fix-now safeword. This is not praise, not a
