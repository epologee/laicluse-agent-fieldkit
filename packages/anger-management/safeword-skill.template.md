...
user-invocable: true
description: >-
  Invoked as /__WORD__. A fix-now safeword: the operator still has enough mental
...
The operator just used "__WORD__" as a fix-now safeword. This is not praise, not a
