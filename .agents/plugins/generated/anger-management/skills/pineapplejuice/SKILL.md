...
name: pineapplejuice
description: >-
  Invoked as /pineapplejuice. A fix-now safeword: the operator still has enough mental
...
The operator just used "pineapplejuice" as a fix-now safeword. This is not praise, not a
