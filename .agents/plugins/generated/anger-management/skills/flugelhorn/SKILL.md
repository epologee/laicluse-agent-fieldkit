...
name: flugelhorn
description: >-
  Invoked as /flugelhorn. A fix-now safeword: the operator still has enough mental
...
The operator just used "flugelhorn" as a fix-now safeword. This is not praise, not a
