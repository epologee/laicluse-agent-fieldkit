...
name: flugelhorn
description: >-
  Explicit fix-now safeword /flugelhorn; route one caught problem into immediate durable repair.
---

# /flugelhorn

The operator just used "flugelhorn" as a fix-now safeword: stop the current work and
