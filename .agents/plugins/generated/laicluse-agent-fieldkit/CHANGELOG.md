...
- **`$whats-new` now works in Codex.** Codex resolves installed Fieldkit
  plugins through `codex plugin list --json`, reads the latest CHANGELOG
  section directly, and receives the marketplace changelog in its generated
  plugin root.
